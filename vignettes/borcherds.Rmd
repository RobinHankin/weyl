...
@hankin2022_weyl_arxiv.  In this short document I discuss Lie algebras
of differential operators as implemented in the `weyl` package.  In a
very nice [youtube
...
operators do not quite commute, but their commutator is itself
first-order.  Symbolically, if
...
Arguably this is easier to see with the other print method:
